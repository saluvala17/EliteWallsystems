...
from brand_styles import get_page_styling, get_sidebar_logo
...
st.markdown('<div class="section-header">💰 Weekly Cost Entry</div>', unsafe_allow_html=True)
st.markdown('<p class="page-subtitle">Enter actual costs for each job by week</p>', unsafe_allow_html=True)
